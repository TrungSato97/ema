...
def create_main_table(df: pd.DataFrame) -> Optional[pd.DataFrame]:
    ...
    # Reorder columns
    final_table = final_table[['noise_ratio', 'method', 'test_acc_orig', 'val_acc_orig', 'best_iteration', 'kept_ratio', 'training_samples_used', 'alpha']]
...
def main():
    ...
    source_dir = Path("./outputs/cifar10_ema_noise_val")
